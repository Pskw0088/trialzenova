...
const courseData = {
  "fitness-busy": {
    ...
    driveLink: "https://drive.google.com/file/d/1ttSSav604aft3EYUXm33A_d_Zj1VWaOg/view?usp=sharing",
  },
  ...
  "fat-loss": {
    ...
    driveLink: "https://https://drive.google.com/file/d/1ttSSav604aft3EYUXm33A_d_Zj1VWaOg/view?usp=sharing.google.com/drive/folders/XXXX_FATLOSS",
  },
}
  ...
  const handlePayment = async () => {
    ...
    const options = {
      ...
      handler: function (response) {
        ...
        alert("Payment Successful ✅ You will be redirected to the course Please Download it!!")
